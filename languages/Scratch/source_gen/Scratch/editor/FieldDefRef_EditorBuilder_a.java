...
/*package*/ class FieldDefRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public FieldDefRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_wxw1yq_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.field$e2tn;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.field$e2tn);
    }
